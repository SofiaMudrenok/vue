  ...
  <div class="card">
    <div class="flip">
      <div class="front">
        ...
        <div class="investor">{{ card.bank }}</div>
        <div class="chip">
        ...
        <div class="card-number">
          <div class="section">{{ card.creditNumber }}</div>
        </div>
        <div class="end">
          <span class="end-text">exp. end:</span
          ><span class="end-date">{{ card.date }}</span>
        </div>
      ...
      <div class="back">
        ...
        <div class="delete">
          <router-link v-bind:to="{ name: 'edit', params: { card_id: card.card_id }}">
